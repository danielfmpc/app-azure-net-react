...
public static class GroupsEndpoint
{
    ...
    {
        endpoints.MapGet("/groups", [Authorize] async ( [FromServices] IMediator mediator)=>
        {
        ...
        endpoints.MapGet("/groups/{groupId}/members", [Authorize] async (string groupId, [FromServices] IMediator mediator)=>
        {
